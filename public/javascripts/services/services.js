define(['angular','javascripts/services/boardManager'], function(angular, boardManager) {
   'use strict';

    return angular.module('services',[])
        .service('boardManager', boardManager)
        .service('loggedUserService',['$rootScope','Restangular','$state', function($rootScope,Restangular,$state){
